...
def plot_event_wf(ind, st_salt, st_simu, st_data, runid, events_simu, 
    ...
    :param events_salt: salt event_info matched to events_simu, default None and event level information from 
                        sprinkled dataset won't be used
    ...
    if events_salt is not None:
        matched_salt_s1_timerange_i = (int((events_salt['s1_time'][ind] - extended_simu_event_timerange_ns[0])/10), 
                                       int((events_salt['s1_endtime'][ind]-extended_simu_event_timerange_ns[0])/10))
        matched_salt_s2_timerange_i = (int((events_salt['s2_time'][ind] - extended_simu_event_timerange_ns[0])/10), 
    ...
    ax1.axvspan(matched_simu_s1_timerange_i[0],matched_simu_s1_timerange_i[1], color='tab:blue', alpha=0.2, label='Simulated S1 Range')
    ax1.axvspan(matched_simu_s2_timerange_i[0],matched_simu_s2_timerange_i[1], color='tab:red', alpha=0.2, label='Simulated S2 Range')
    if events_salt is not None:
        ax1.axvspan(matched_salt_s1_timerange_i[0],matched_salt_s1_timerange_i[1], color='b', alpha=0.2, label='Sprinkled S1 Range')
        ax1.axvspan(matched_salt_s2_timerange_i[0],matched_salt_s2_timerange_i[1], color='r', alpha=0.2, label='Sprinkled S2 Range')
    ax1.legend()
    if events_salt is not None:
        ...
        ax1.set_title("Run %s Event %s: Simu S1=%sPE, S2=%sPE"%(runid, ind, 
                                                            int(10*events_simu['s1_area'][ind])/10, 
                                                            int(10*events_simu['s2_area'][ind])/10))
    ax1.set_ylim(ylim)
    ...
    ax2.axvspan(matched_simu_s1_timerange_i[0],matched_simu_s1_timerange_i[1], color='tab:blue', alpha=0.2, label='Simulated S1 Range')
    ax2.axvspan(matched_simu_s2_timerange_i[0],matched_simu_s2_timerange_i[1], color='tab:red', alpha=0.2, label='Simulated S2 Range')
    if events_salt is not None:
        ax2.axvspan(matched_salt_s1_timerange_i[0],matched_salt_s1_timerange_i[1], color='b', alpha=0.2, label='Sprinkled S1 Range')
    ...
    axs[0,0].axvspan(matched_simu_s1_timerange_i[0],matched_simu_s1_timerange_i[1], color='tab:blue', alpha=0.2, label='Simulated S1 Range')
    axs[0,0].axvspan(matched_simu_s2_timerange_i[0],matched_simu_s2_timerange_i[1], color='tab:red', alpha=0.2, label='Simulated S2 Range')
    if events_salt is not None:
        axs[0,0].axvspan(matched_salt_s1_timerange_i[0],matched_salt_s1_timerange_i[1], color='b', alpha=0.2, label='Sprinkled S1 Range')
        axs[0,0].axvspan(matched_salt_s2_timerange_i[0],matched_salt_s2_timerange_i[1], color='r', alpha=0.2, label='Sprinkled S2 Range')
    ...
    axs[0,1].axvspan(matched_simu_s1_timerange_i[0],matched_simu_s1_timerange_i[1], color='tab:blue', alpha=0.2, label='Simulated S1 Range')
    axs[0,1].axvspan(matched_simu_s2_timerange_i[0],matched_simu_s2_timerange_i[1], color='tab:red', alpha=0.2, label='Simulated S2 Range')
    if events_salt is not None:
        axs[0,1].axvspan(matched_salt_s1_timerange_i[0],matched_salt_s1_timerange_i[1], color='b', alpha=0.2, label='Sprinkled S1 Range')
        axs[0,1].axvspan(matched_salt_s2_timerange_i[0],matched_salt_s2_timerange_i[1], color='r', alpha=0.2, label='Sprinkled S2 Range')
    ...
    axs[1,0].axvspan(matched_simu_s1_timerange_i[0],matched_simu_s1_timerange_i[1], color='tab:blue', alpha=0.2, label='Simulated S1 Range')
    axs[1,0].axvspan(matched_simu_s2_timerange_i[0],matched_simu_s2_timerange_i[1], color='tab:red', alpha=0.2, label='Simulated S2 Range')
    axs[1,0].set_xlim(matched_simu_s1_timerange_i[0]-s1_ext_window_samples, 
                      matched_simu_s1_timerange_i[1]+s1_ext_window_samples)
    if events_salt is not None:
        axs[1,0].axvspan(matched_salt_s1_timerange_i[0],matched_salt_s1_timerange_i[1], color='b', alpha=0.2, label='Sprinkled S1 Range')
        axs[1,0].axvspan(matched_salt_s2_timerange_i[0],matched_salt_s2_timerange_i[1], color='r', alpha=0.2, label='Sprinkled S2 Range')
        axs[1,0].set_xlim(matched_salt_s1_timerange_i[0]-s1_ext_window_samples,
    ...
    axs[1,1].axvspan(matched_simu_s1_timerange_i[0],matched_simu_s1_timerange_i[1], color='tab:blue', alpha=0.2, label='Simulated S1 Range')
    axs[1,1].axvspan(matched_simu_s2_timerange_i[0],matched_simu_s2_timerange_i[1], color='tab:red', alpha=0.2, label='Simulated S2 Range')
    axs[1,1].set_xlim(matched_simu_s2_timerange_i[0]-s2_ext_window_samples, 
                      matched_simu_s2_timerange_i[1]+s2_ext_window_samples)
    if events_salt is not None:
        axs[1,1].axvspan(matched_salt_s1_timerange_i[0],matched_salt_s1_timerange_i[1], color='b', alpha=0.2, label='Sprinkled S1 Range')
        axs[1,1].axvspan(matched_salt_s2_timerange_i[0],matched_salt_s2_timerange_i[1], color='r', alpha=0.2, label='Sprinkled S2 Range')
        axs[1,1].set_xlim(matched_salt_s2_timerange_i[0]-s2_ext_window_samples, 
